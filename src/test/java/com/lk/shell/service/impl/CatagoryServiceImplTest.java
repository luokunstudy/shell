...
public class CatagoryServiceImplTest {
    ...
    public void findOne() throws Exception {
        ProductCategory productCategory =catagoryService.findOne(1);
    ...
    public void findByCategoryTypeIn() throws Exception {
        List<ProductCategory> productCategoryList =catagoryService.findByCategoryTypeIn(Arrays.asList(1,2,3,4));
        Assert.assertNotEquals(0,productCategoryList.size());
    }
    ...
    public void save() throws Exception {
        ...
        ProductCategory result = catagoryService.save(productCategory);
    }
